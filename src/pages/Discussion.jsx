  ...
  return (
    <div>
      ...
      <div className="flex flex-col justify-center w-[70%] mx-auto">
        <div className='my-5 justify-between flex '> <Button onClick={askhandler} sx={{borderRadius:"30px"}} variant="contained" size="medium">
          Ask a Question
        </Button>
        <div>
          {/* search bar */}
        ...
        {/* array of Questions */}
        <div>
            <Discusions_container key={questionList.id} questionList={questionList} />
        </div>
